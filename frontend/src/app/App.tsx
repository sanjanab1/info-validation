        ...
        if (match) {
          ...
          return (
            <a
              ...
              className={`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-medium align-middle transition-colors ${colors[confidence as keyof typeof colors]}`}
            >
              {sourceLabel}
            </a>
          );
